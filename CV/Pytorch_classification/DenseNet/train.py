...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str,
                        default=r"/Users/WH/Desktop/pytorch_classification/")

    # densenet121 官方权重下载地址
    # https://download.pytorch.org/models/densenet121-a639ec97.pth
    parser.add_argument('--weights', type=str, default=r"/Users/WH/Desktop/pytorch_classification/densenet121.pth",
